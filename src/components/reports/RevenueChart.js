...
const RevenueChart = ({ data, height = 300 }) => {
    if (!data || data.length === 0) {
        return (_jsx("div", { className: "flex items-center justify-center h-64 text-gray-500", children: "Tidak ada data revenue untuk ditampilkan" }));
    }
    const chartData = {
    ...
    return (_jsx("div", { style: { height: `${height}px` }, children: _jsx(Bar, { data: chartData, options: options }) }));
};
