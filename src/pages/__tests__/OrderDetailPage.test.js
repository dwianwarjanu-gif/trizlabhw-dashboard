...
const createWrapper = () => {
    ...
    return ({ children }) => (_jsx(QueryClientProvider, { client: queryClient, children: _jsx(MemoryRouter, { initialEntries: ['/orders/test-order-id'], children: children }) }));
};
describe('OrderDetailPage', () => {
    ...
    it('renders loading state initially', () => {
        ...
        render(_jsx(OrderDetailPage, {}), { wrapper: createWrapper() });
...
//# sourceMappingURL=OrderDetailPage.test.js.map